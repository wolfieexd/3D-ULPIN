      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <main className="flex-1 relative bg-slate-800">
          ...
          >
            ...
            {(exploreFloors || (demoStep >= 7 && demoStep <= 13) || (demoStep === 0 && selectedBuildingId === 'B001')) && primaryBuilding && floors.features?.map((f: any, i: number) => {
              if (!f._cachedHierarchy) return null;
            ...
            {(demoStep >= 10 || (exploreFloors && activeFloor)) && units.features?.map((f: any, i: number) => {
              if (!f._cachedHierarchy) return null;
              const v = f.properties;
