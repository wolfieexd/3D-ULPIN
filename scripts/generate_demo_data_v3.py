...
for f in range(4):
    ...
    for u in range(min(4, len(unit_geoms))):
        ...
        area_m2 = ShapelyPolygon(unit_geoms[u]).area * 1e10 # approximate rough
...
print("Data generated successfully with strict cadastral hierarchy and Shapely intersection.")
